...
using Alachisoft.TayzGrid.Web.SessionStateManagement.LocationAffinity;
#else
...
#if JAVA
namespace Alachisoft.TayzGrid.Web.SessionStateManagement
#else
...
//#endif
{
    ...
    public class SingleRegionCache : ISessionCache
    {
...
#if JAVA
        private Alachisoft.TayzGrid.Web.Caching.Cache _cache = null;
#else
        ...
        {
#if JAVA
            _cache = Alachisoft.TayzGrid.Web.Caching.TayzGrid.InitializeCache(cache);
#else
        ...
        public object Get(string sessionId, string key, ref LockHandle lockHandle, bool acquireLock, bool enableRetry)
        {
            ...
            do
            {
                ...
                {
#if JAVA
                    value = _cache.Get(key, Alachisoft.TayzGrid.Web.Caching.Cache.NoLockExpiration, ref lockHandle, acquireLock); 
#else
