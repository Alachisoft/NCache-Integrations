...
namespace Alachisoft.NCache.EntityFrameworkCore
{
    ...
    public class NCacheConfiguration
    {
        ...
        public static int BulkInsertChunkSize => _bulkInsertChunkSize;
        ...
        /// <summary>
        /// Flag specifying whether the excpetion will be thrown or not . True value 
        /// corresponds to throw the exception and false corresponds to,will not throw the exception 
        /// </summary>
        public static bool IsErrorEnabled => _isErrorEnabled;

        public static CacheConnectionOptions InitParams => _initParams;
        ...
        public static void Configure(string cacheId, DependencyType databaseType/*, DbContext context*/, bool errorEnabled = false, int bulkInsertChunkSize = 1000)
        {
            _cacheId = cacheId;
            ...
            _isErrorEnabled = errorEnabled;
            _bulkInsertChunkSize = bulkInsertChunkSize;
        }
        ...
        public static void Configure(string cacheId, DependencyType databaseType, /*DbContext context, */CacheConnectionOptions initParams, bool errorEnabled = false, int bulkInsertChunkSize = 1000)
        {
            _initParams = initParams;
            Configure(cacheId, databaseType, errorEnabled, bulkInsertChunkSize/*, context*/);
        }
