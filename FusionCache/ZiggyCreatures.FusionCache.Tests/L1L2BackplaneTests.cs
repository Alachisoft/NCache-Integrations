	...
	: AbstractTests
{
	...
	private readonly TimeSpan InitialBackplaneDelay = TimeSpan.FromMilliseconds(1000);
	private readonly TimeSpan MultiNodeOperationsDelay = TimeSpan.FromMilliseconds(1000);
